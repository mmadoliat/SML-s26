---
title: "Syllabus - Statistical Machine Learning"
format: 
  html: default
  pdf: default
---
...
**Location:** Cudahy Hall 208 ([Microsoft Teams](https://teams.microsoft.com/meet/29401373633432?p=dfNhq6676bM9F3sMX3))\
...
Multivariate data and exploratory analysis, random vector and multivariate normal distribution, multivariate linear regression, principal component and other dimensional reduction techniques, linear discriminant analysis, recursive partition and tree-based methods including classification tree and regression tree, cluster analysis, neural network, support vector machine.

## Flyer

[Statistical Machine Learning (SML)](https://www.mssc.mu.edu/~mehdi/SML-Sp26-Flyer.pdf) - [https://www.mssc.mu.edu/~mehdi/SML-Sp21-Flyer.pdf](https://www.mssc.mu.edu/~mehdi/SML-Sp26-Flyer.pdf)

## Prerequisites

-   A course in Statistical Methods, and 
-   A course in Linear Algebra.

## Textbooks

-   [*An Introduction to Statistical Learning*, with Applications in Python](https://hastie.su.domains/ISLP/ISLP_website.pdf.download.html) by G. James, D. Witten, T. Hastie, R. Tibshirani, and J. Taylor, 2023. ISBN: 978-3031387463.
-   [*An Introduction to Statistical Learning*, with Applications in R, Second Edition](https://hastie.su.domains/ISLR2/ISLRv2_corrected_June_2023.pdf.download.html) by G. James, D. Witten, T. Hastie, and R. Tibshirani, 2021. ISBN: 978-1071614174.
...
-   **Project:** 25%
-   **Midterm Exam:** 25%
-   **Final Exam or Project Report (Instructor will decide):** 25%
...
-   There will be a midterm (in class) on Mar. 5th, plus 
-   A tentative final (in-class or take-home): May. 5th from 10:30 - 12:30 pm.
...
-   **Tuesday, January 20**: Drop/add ends
-   **Sunday - Saturday, March 8 - 14**: Fall Break
-   **Thursday - Sunday, April 2 - 5**: Easter Break
-   **Friday, April 10**: Last day to withdraw with W
-   **Saturday, May 2**: Classes end
-   **Tuesday, May 5, 10:30 am - 12:30 pm**: Presentations

For more important dates, see the full [MU Academic Calendar](https://www.marquette.edu/central/registrar/2026-spring-academic-calendar.php).
