...
-   ML: Could a computer surprise us? Rather than programmers crafting data-processing rules by hand, could a computer automatically learn these rules by looking at data? ![](images/DLiR/machine-learning.png){.absolute top="225" left="530" width="400px"}
...
::: incremental
-   Input data points, e.g. ![](images/DLiR/mse-1.png){.absolute bottom="0" left="300" width="400"}
...
-   Examples of the expected output ![](images/DLiR/mse-2.png){.absolute bottom="0" left="300" width="400"}
...
-   A way to measure whether the algorithm is doing a good job ![](images/DLiR/mse-3.png){.absolute bottom="0" left="300" width="400"}
    ...
    -   The measurement is used as a feedback signal to adjust the way the algorithm works.
        ...
        ::: {style="margin-top: -30px;"}
        ![](images/DLiR/mse-4.png){.absolute bottom="0" left="300" width="400"}
        :::
:::
...
::: incremental
-   The [*input data*]{.text-red} and corresponding [*targets*]{.text-red} ![](images/DLiR/nn-1.png){.absolute bottom="0" left="40" width="500"}

-   [*Layers*]{.text-red}, which are combined into a [*network* (or *model*)]{.text-red} ![](images/DLiR/nn-2.png){.absolute bottom="0" left="40" width="500"}

-   The [*loss function*]{.text-red}, which provides feedback for learning ![](images/DLiR/nn-3.png){.absolute bottom="0" left="40" width="500"}

-   The [*optimizer*]{.text-red}, which determines how learning proceeds ![](images/DLiR/nn-4.png){.absolute bottom="0" left="40" width="500"}
:::
...
## LeNet-5: a pioneering 7-level CNN {.smaller auto-animate="true"}

<img src="images/DLiR/LeNet-5_architecture.png" style="opacity: 0.10;"/>
...
<img src="images/DLiR/imagenet-1.png" style="opacity: 0.10" width="1200"/>
...
-   in 2012, a team led by Alex Krizhevsky and advised by [*Geoffrey Hinton*]{.text-red} was able to achieve a top-five accuracy of 83.6%--a significant breakthrough (in 2011 it was only 74.3%). ![](images/DLiR/imagenet-2.png){.absolute bottom="0" right="0" width="350" height="300"}
...
## VGG16–CNN for Classification and Detection {.smaller auto-animate="true"}

<img src="images/DLiR/VGG16-1.png" style="opacity: 0.10" width="1500"/>
...
-   VGG16 was trained for weeks using NVIDIA Titan Black GPU’s. ![](images/DLiR/VGG16-2.png){.absolute bottom="0" left="250" width="500"}
:::
...
[**Hidden Layers Disappears**]{.text-red}
...
## Real-world examples of data tensors {.smaller auto-animate="true"}

<img src="images/DLiR/tensors_flowing.gif" style="opacity: 0.05;" width="420"/>

-   2D tensors
    -   Vector data—(samples, features) ![](images/DLiR/tensor-2d.png){.absolute top="60" left="475" width="150"} ![](images/DLiR/tensor2D.png){.absolute top="50" right="0" width="400"}
...
![](images/DLiR/tensor-3d.png){.absolute top="290" left="475" width="150"} ![](images/DLiR/tensor3D.png){.absolute top="300" right="0" width="400"}
...
![](images/DLiR/tensor-4d.png){.absolute top="350" left="150" width="75"} ![](images/DLiR/tensor4D.png){.absolute top="450" right="0" width="275"}
...
<script type="text/javascript"> trends.embed.renderExploreWidget("TIMESERIES", {"comparisonItem":[{"keyword":"TensorFlow","geo":"","time":"2015-01-01 2030-05-15"},{"keyword":"Pytorch","geo":"","time":"2015-01-01 2030-05-15"},{"keyword":"Keras","geo":"","time":"2015-01-01 2030-05-15"},{"keyword":"TensorFlow + Keras","geo":"","time":"2015-01-01 2030-05-15"}],"category":0,"property":""}, {"exploreQuery":"date=2015-01-01%202030-05-15&q=TensorFlow,Pytorch,Keras,TensorFlow%20%2B%20Keras","guestPath":"https://trends.google.com:443/trends/embed/"}); </script>
:::

. . .

![](images/DLiR/keras.png){.absolute bottom="325" right="0" width="350"} ![](images/DLiR/keras-2.png){.absolute bottom="0" right="30" width="275"}
...
![](images/DLiR/one-hot-encoding.png){.absolute top="140" left="50" width="450"} ![](images/DLiR/embedding.png){.absolute top="100" right="50" width="450"}

::: {style="margin-top: 320px; margin-left: 50px;"}
:::
...
3.  Create an autoencoder for dimensionality reduction and visualize embeddings ![](images/DLiR/embedding.png){.absolute bottom="0" right="120" width="400"}
